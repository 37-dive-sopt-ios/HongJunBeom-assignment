...
protocol CombineWelcomeViewControllerDelegate: AnyObject {
    func backToLogin()
}

class WelcomeViewController_Combine: UIViewController {
    
    var name: String?
    
    weak var delegate: CombineWelcomeViewControllerDelegate?
...
extension WelcomeViewController_Combine: CustomNavigationDelegate {
    @objc
