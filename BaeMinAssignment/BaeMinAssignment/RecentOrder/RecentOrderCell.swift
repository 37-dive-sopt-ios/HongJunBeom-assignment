...
final class RecentOrderCell: UICollectionViewCell {
    static let identifier: String = "RecentOrderCell"
    
    private let recentOrderImageView: UIImageView = {
    ...
    private let recentCountLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.font(.pretendardRegular, ofSize: 12)
        label.textAlignment = .left
        label.textColor = .baeminBodyR12
        return label
    }()
    ...
    private func setHierarchy() {
        ...
        verticalStackView.addArrangedSubview(recentCountLabel)
        ...
        contentView.addSubview(recentOrderImageView)
    ...
    private func setLayout() {
        ...
        verticalStackView.snp.makeConstraints {
            $0.top.equalTo(recentOrderImageView.snp.bottom).offset(4)
            $0.leading.trailing.equalTo(recentOrderImageView)
        }
    ...
    public func configure(feed: RecentOrderModel) {
        recentOrderImageView.image = feed.recentOrderImage
        recentCountLabel.text = feed.recentCount
